 ...
 */
public class PackageOfferRequest extends PackageRequest implements Pageable {
    ...
    public PackageOfferRequest(Context context, RequestOptions options, PackageRequestParameters parameters, Pagination pagination) {
