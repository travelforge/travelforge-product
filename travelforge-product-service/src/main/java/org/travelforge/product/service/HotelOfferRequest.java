...
public class HotelOfferRequest extends HotelRequest implements Pageable {
    ...
    public HotelOfferRequest() {
    }

    public HotelOfferRequest(Context context, RequestOptions options, HotelRequestParameters parameters, Pagination pagination) {
    ...
    public boolean equals(Object o) {
        ...
        HotelOfferRequest that = (HotelOfferRequest) o;
