...
public class PackageVariantRequest extends PackageRequest implements Pageable {
    ...
    public PackageVariantRequest() {
        super();
    }

    public PackageVariantRequest(Context context, RequestOptions options, PackageRequestParameters parameters, List<String> variants, Pagination pagination) {
