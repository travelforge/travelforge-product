 ...
 */
public class PackageProductResponse extends PackageResponse {
    ...
    public PackageProductResponse(Context context, PageInfo pageInfo, List<PackageProduct> products) {
        super(context);
