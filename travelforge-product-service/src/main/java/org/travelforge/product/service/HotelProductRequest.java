...
public class HotelProductRequest extends HotelRequest implements Pageable {
    ...
    public HotelProductRequest() {
    }

    public HotelProductRequest(Context context, RequestOptions options, HotelRequestParameters parameters, Pagination pagination) {
    ...
    public boolean equals(Object o) {
        ...
        HotelProductRequest that = (HotelProductRequest) o;
