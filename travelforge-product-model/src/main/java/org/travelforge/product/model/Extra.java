...
public class Extra implements Serializable {
    ...
    public Extra(String code, String name) {
        this.code = code;
        this.name = name;
    }
    ...
    public static class Builder<T_BUILDER extends Builder, T_EXTRA extends Extra> {
        ...
        @SuppressWarnings("unchecked")
        public T_EXTRA build() {
            return (T_EXTRA) new Extra(code, name);
        }
    }
}
